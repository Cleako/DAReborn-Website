 ...
 * false otherwise.
 */
function addNewUser($username, $password, $email, $name, $msn, $yahoo, $icq, $aim, $country, $birth, $attack, $defence, $strength, $hitpoints, $ranged, $prayer, $magic, $cooking, $woodcutting, $fletching, $fishing, $firemaking, $crafting, $smithing, $mining, $herblore, $agility, $thieving, $runecrafting, $combat, $overall, $user_level, $other, $dl, $clanname, $url, $totmembers, $rs, $squad){
   global $conn;
   $q = "INSERT INTO users (username,password,email,name,msn,yahoo,icq,aim,country,birth,attack,defence,strength,hitpoints,ranged,prayer,magic,cooking,woodcutting,fletching,fishing,firemaking,crafting,smithing,mining,herblore,agility,thieving,runecrafting,combat,overall,user_level,other,dl,clanname,url,totmembers,rs,squad) VALUES ('$username', '$password', '$email', '$name', '$msn', '$yahoo', '$icq', '$aim', '$country', '$birth', '$attack', '$defence', '$strength', '$hitpoints', '$ranged', '$prayer', '$magic', '$cooking', '$woodcutting', '$fletching', '$fishing', '$firemaking', '$crafting', '$smithing', '$mining', '$herblore', '$agility', '$thieving', '$runecrafting', '$combat', '$overall', '$user_level', '$other', '$dl', '$clanname', '$url', '$totmembers', '$rs', '$squad')";
...
<BR>
If you'd like to ally us, please fill out this form<BR><BR>
...
<input type="hidden" value="Diplomat" name="dl" maxlength="100">
<tr><td>Clan Name:</td><td><input type="text" name="clanname" maxlength="100"></td></tr>
<tr><td>Clan Website:</td><td><input type="text" name="url" maxlength="100"></td></tr>
<tr><td>Total Members:</td><td><input type="text" name="totmembers" maxlength="100"></td></tr>

<tr><td></td><td><input type="hidden" value="100" name="user_level" maxlength="4"></td></tr>
<tr><td>Anything else you'd like to tell us?:</td><td><textarea cols="40" rows="6" name=other></textarea></td></tr>
